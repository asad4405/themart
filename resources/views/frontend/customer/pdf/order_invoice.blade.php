...
<body>
    <header class="clearfix">
        ...
        <div id="company">
            ...
            <div>01777777777</div>
            <div><a href="">themart@gmail.com</a></div>
        </div>
        </div>
    </header>
    <main>
        <div id="details" class="clearfix">
            ...
            <div id="client">
                ...
                <div>
                    ...
                    <h2 class="name">{{ $ship->fname }} {{ $ship->lname }}</h2>
                    <div class="address">{{ $ship->address }}, {{ $ship->city->name }}, {{ $ship->zip }} ,
                        {{ $ship->country->name }}</div>
                    <div class="email"><a href="">{{ $ship->email }}</a></div>
                </div>
            </div>
            <div id="invoice">
